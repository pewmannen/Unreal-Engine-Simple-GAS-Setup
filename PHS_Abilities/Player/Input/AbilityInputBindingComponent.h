 ...
 *     and InputComponent initialization (matches Motion's own retry pattern).
 *  4. Timer and delegate both clean themselves up on first successful bind.
 *
 * To port to a new project: rename PROJECTHELLSHIFT_API. No other changes needed.
 */
UCLASS(Blueprintable, ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class PROJECTHELLSHIFT_API UAbilityInputBindingComponent : public UActorComponent
{
	GENERATED_BODY()

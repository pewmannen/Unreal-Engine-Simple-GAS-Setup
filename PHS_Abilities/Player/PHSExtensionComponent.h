 ...
 *  - Rename PROJECTHELLSHIFT_API to the new module export macro.
 ...
 */
UCLASS(Blueprintable, ClassGroup = (ProjectHellshift), meta = (BlueprintSpawnableComponent))
class PROJECTHELLSHIFT_API UPHSExtensionComponent : public UActorComponent
{
	GENERATED_BODY()
